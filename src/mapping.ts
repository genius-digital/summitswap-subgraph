...
export function handleOwnershipTransferred(event: OwnershipTransferred): void {
  ...
  // - contract.summitReferral(...)
  // - contract.swapExactTokensForETH(...)
  // - contract.swapExactTokensForETHReferral(...)
  // - contract.swapExactTokensForTokens(...)
  // - contract.swapExactTokensForTokensReferral(...)
  // - contract.swapTokensForExactETH(...)
  // - contract.swapTokensForExactETHReferral(...)
  // - contract.swapTokensForExactTokens(...)
  // - contract.swapTokensForExactTokensReferral(...)
}
