...
export function handleSync(event: Sync): void {
  ...
  summit.totalLiquidityBNB = summit.totalLiquidityBNB.plus(trackedLiquidityBNB)
  summit.totalLiquidityUSD = summit.totalLiquidityBNB.times(bundle.bnbPrice)
...
export function handleSwap(event: Swap): void {
  ...
  let summitDayData = updateSummitDayData(event)
