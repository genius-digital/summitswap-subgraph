...
export function updateSummitDayData(event: ethereum.Event): SummitDayData {
  ...
  let summitDayData = SummitDayData.load(dayID.toString())
  if (summitDayData === null) {
    summitDayData = new SummitDayData(dayID.toString())
    summitDayData.date = dayStartTimestamp
    summitDayData.dailyVolumeUSD = ZERO_BD
    summitDayData.dailyVolumeBNB = ZERO_BD
    summitDayData.totalVolumeUSD = ZERO_BD
    summitDayData.totalVolumeBNB = ZERO_BD
    summitDayData.dailyVolumeUntracked = ZERO_BD
  }
  summitDayData.totalLiquidityUSD = summit.totalLiquidityUSD
  summitDayData.totalLiquidityBNB = summit.totalLiquidityBNB
  summitDayData.totalTransactions = summit.totalTransactions
  summitDayData.save()

  return summitDayData as SummitDayData
}
